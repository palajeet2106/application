                ...
                <div class="alert alert-success" id="message"></div>
                    <form method="post" action="code.php" id = "form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="coordinatorName" name="coordinator_name" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="aict" name="aicte" required>
                        </div>

                        <div class="form-group">
                            <label for="teqip"><b>Teqip:</b></label>
                            <input type="text" class="form-control" id="teqip" name="teqip" required>
                        </div>

                        <div class="form-group">
                            <label for="applDate"><b>Appl.date:</b></label>
                            <input type="date" class="form-control" id="applDate" name="appl_date" required>
                        </div>
