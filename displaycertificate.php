...
<div class="container-fluid mt-5 ">
        ...
        <div class="row">
            ...
            <a href="logout.php" class=" float-end m-1 mb-2 btn btn-danger text-decoration-none text-white">Log Out</a>
                    <a href="certificate.php" class=" m-1 float-end mb-2 btn btn-primary text-decoration-none text-white">Add  Record</a>
                    
                
                <table class = "table table-striped table-bordered text-center">
                    <thead>
                        <tr>
                            <th colspan="11" class="text-center bg-primary text-white">List of Short Term Course Attended by you</th>
